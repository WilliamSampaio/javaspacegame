...
public final class Fase extends JPanel implements ActionListener {
    ...
    public Fase() throws LineUnavailableException, IOException {
    ...
    public void setFase(int fase) {
        switch (fase) {
            ...
            default -> sonic.setIsVisible(false);
        }
    }
    ...
    public void paint(Graphics g) {
        ...
        switch (emJogo) {
            case ESTADO_EMJOGO -> {
                ...
                graficos.setFont(new Font("arial", Font.BOLD, 20));
                graficos.setColor(Color.WHITE);
                graficos.drawString("VIDAS: " + vidas, 200, 15);
                
                graficos.setFont(new Font("arial", Font.BOLD, 20));
                graficos.setColor(Color.WHITE);
                graficos.drawString("NAVE: " + naveAtual, 350, 15);                
                
                graficos.setFont(new Font("arial", Font.BOLD, 20));
                graficos.setColor(Color.WHITE);
                graficos.drawString("FASE: " + faseAtual, 500, 15);
            }
            case ESTADO_FASECONCLUIDA -> {
                ImageIcon _parabens = new ImageIcon("./fontes/fisica2/parabens.jpg");
                // graficos.drawImage(parabens.getImage(), 220, 50, null);
                graficos.drawImage(_parabens.getImage(), 220, 50, null);
            }
            case ESTADO_GAMEOVER ->  {
                var fimJogo = new ImageIcon("./fontes/fisica2/game-over1.jpg");
                graficos.drawImage(fimJogo.getImage(), 425, 150, 389, 282, this);
            }
            case ESTADO_MENU ->  {
                ImageIcon fimJogo = new ImageIcon("./fontes/fisica2/logo.png");
                graficos.drawImage(fimJogo.getImage(), 150, 150, null);
                graficos.setFont(new Font("arial", Font.BOLD, 20));
                graficos.setColor(Color.WHITE);
                graficos.drawString("PRESSIONE ENTER PARA INICIAR", 525, 550);
